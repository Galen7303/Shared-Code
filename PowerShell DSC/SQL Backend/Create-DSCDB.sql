...
-- Adding Permissions
CREATE USER [DSCSQLUser] FOR LOGIN [{0}\DSCSQLUser] WITH DEFAULT_SCHEMA=[db_datareader]
GO

ALTER ROLE [db_datareader] ADD MEMBER [DSCSQLUser]
GO

ALTER ROLE [db_datawriter] ADD MEMBER [DSCSQLUser]
GO
